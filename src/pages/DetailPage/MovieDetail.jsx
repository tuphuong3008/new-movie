        ...
        <Box id="movie-detail-page" className="movie-detail-page">
          <Box>
            ...
            >
              ...
              <Container className="movie-detail__top-info-wrapper container">
                ...
                <Box className="top-info__content hide-on-mobile-tablet">
                  ...
                  <Container
                    maxWidth="md"
                    className="movie-detail__content-wrapper container"
                  >
                    <Typography
                      className="top-info__content-title"
                    ...
                    >
                      ...
                      <Grid
                        ...
                        xs={12}
                        md={5}
                        className="movie-detail__details"
                      >
                        <h4 className="movie-detail__content-title">
                          Chi tiết
                        </h4>
                        <p>
                          Ngày công chiếu:{" "}
                          {moment(data.ngayKhoiChieu).format("D/M/YYYY hh:mm")}
                        </p>
                      </Grid>
                    </Grid>
                  </Container>
            ...
            <Box className="movie-detail__top-desc hide-on-mobile-tablet">
              ...
              <Box className="movie-detail__desc-right">
                {renderSocialBtn()}
              </Box>
            </Box>
          </Box>
