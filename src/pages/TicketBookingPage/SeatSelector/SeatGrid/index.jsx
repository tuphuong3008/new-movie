...
// Constants
import {chooseSeat} from '../../../../redux/slice/ticketBooking'
...
const SeatGrid = () => {
  ...
  const ticketBookingDetails = useSelector((state) => state.ticketBookingSlice.ticketBookingDetails);
  const selectedSeats = useSelector((state) => state.ticketBookingSlice.selectedSeats);


  const dispatch = useDispatch();

  const seats = ticketBookingDetails.data?.data?.content.danhSachGhe;
